...
def generate_launch_description():
    ...
    # Call xarm7 planner launch file for connection to the real robot
    xarm_planner_node = IncludeLaunchDescription(
        PythonLaunchDescriptionSource(
            os.path.join(get_package_share_directory('xarm_planner'), 'launch', 'xarm7_planner_realmove.launch.py' )
        ),
        launch_arguments=[
            ('robot_ip', '192.168.1.238'),
            ('add_gripper', 'False'),
        ]
    )
    ...
    # otherwise, call from the lauch file:
